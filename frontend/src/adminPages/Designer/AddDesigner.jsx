...
function AddDesigner() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(
        err.response?.data?.message || "❌ Failed to add designer. Try again.",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          <div className="bg-gradient-to-r from-indigo-600 to-indigo-500 py-5 px-6">
            <h1 className="text-2xl font-bold text-white">Add New Designer</h1>
            <p className="text-indigo-100 mt-1">
              Fill in the details below to add a designer
            </p>
          </div>
